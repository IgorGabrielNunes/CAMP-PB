...
function inicializarBancoDeDados() {
  ...
  const timesPadrao = [
    {
      id: "t_1",
      nome: "Uncharted Black",
      tag: "UNC",
      players: [
        { id: "p_1", nickname: "Vander" },
        { id: "p_2", nickname: "Digo" },
        { id: "p_3", nickname: "Koyote" },
        { id: "p_4", nickname: "Head" },
        { id: "p_5", nickname: "Nyx" },
      ],
    },
    {
      ...
      tag: "BD",
      players: [
        { id: "p_6", nickname: "Foox" },
        { id: "p_7", nickname: "Patoxy" },
        { id: "p_8", nickname: "Prozin" },
        { id: "p_9", nickname: "Bezn" },
        { id: "p_10", nickname: "Rnd" },
      ],
    },
...
const StoragePB = {
  ...
  saveTorneio: (dados) =>
    localStorage.setItem("pb_torneio", JSON.stringify(dados)),

  getTimesGlobais: () =>
    JSON.parse(localStorage.getItem("pb_times_globais")) || [],
  saveTimesGlobais: (times) =>
    localStorage.setItem("pb_times_globais", JSON.stringify(times)),
